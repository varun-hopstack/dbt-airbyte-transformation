...
-- depends_on: {{ ref('orders_rawdata_shipping_address_ab1') }}
select
    ...
    cast(shipping_address_id as {{ dbt_utils.type_float() }}) as shipping_address_id,
    _airbyte_ab_id,
    _airbyte_emitted_at,
    {{ current_timestamp() }} as _airbyte_normalized_at
from {{ ref('orders_rawdata_shipping_address_ab1') }}
